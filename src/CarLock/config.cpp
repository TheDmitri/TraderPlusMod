...
class CfgSoundSets
{
	class cl_CarLock_CarAlarm_SoundSet
	{
		soundShaders[]=
		{
			"cl_CarLock_CarAlarm_SoundShader"
		};
	};
	class cl_CarLock_CarLock_SoundSet
	{
		soundShaders[]=
		{
			"cl_CarLock_CarLock_SoundShader"
		};
	};
	class cl_CarLock_CarUnlock_SoundSet
	{
		soundShaders[]=
		{
			"cl_CarLock_CarUnlock_SoundShader"
		};
	};
};
