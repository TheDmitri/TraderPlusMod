		...
		class defs
		{
			class gameScriptModule
			{
				...
				files[]=
				{
					...
					"TPDefine/scripts/Common",
					"TraderPlus/scripts/Common",
					"TraderPlus/scripts/3_Game"
				};
			};
...
class CfgSoundSets
{
	class TraderPlus_Sound_Buy_SoundSet
	{
		soundShaders[]=
		{
			"TraderPlus_Sound_Buy_SoundShader"
		};
		volumeFactor=1.4;
	...
	class TraderPlus_Sound_Sell_SoundSet
	{
		soundShaders[]=
		{
			"TraderPlus_Sound_Sell_SoundShader"
		};
		volumeFactor=1.4;
		volumeCurve="InverseSquare2Curve";
		spatial=1;
	...
	class TraderPlus_Sound_Quick_Event_SoundSet
	{
		soundShaders[]=
		{
			"TraderPlus_Sound_Quick_Event_SoundShader"
		};
		volumeFactor=1.4;
		volumeCurve="InverseSquare2Curve";
		spatial=1;
